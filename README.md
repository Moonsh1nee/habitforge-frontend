...
| **Достижения** | XP, уровни, 13 ачивментов, live-уведомления о разблокировке через WebSocket |
| **Модули** | Разделы приложения (задачи, привычки, цели, дневник, аналитика, достижения) можно скрыть/показать в настройках профиля — скрытые разделы не удаляют данные, синхронизируется с бэкендом |
| **OAuth2-провайдер** | `/oauth/consent` — экран согласия, когда сторонние приложения ([Wisely](https://github.com/Moonsh1nee/Wisely), [Fuel](https://github.com/Moonsh1nee/Fuel)) просят вход "через GetGrip" |
...
├── src/
│   ├── app/
│   │   ├── (auth)/                   ← страницы входа, регистрации и OAuth2-согласия
│   │   │   ├── login/page.tsx
│   │   │   ├── register/page.tsx
│   │   │   └── oauth/consent/        ← "Wisely просит доступ к вашему аккаунту GetGrip" — экран согласия для стороннего клиента
...
│   │   │   ├── upgrade/              ← тарифы, Stripe checkout CTA
│   │   │   └── profile/              ← профиль, аватар, пароль, активные сессии
...
- [x] GetGrip как OAuth2-провайдер — "Войти через GetGrip" для [Wisely](https://github.com/Moonsh1nee/Wisely) и [Fuel](https://github.com/Moonsh1nee/Fuel)
- [ ] Kanban-вид задач
